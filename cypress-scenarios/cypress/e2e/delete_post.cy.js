...
describe('Testing delete post', () => {
    ...
    it('Delete Post', ()=>{
        ...
        cy.fixture('index.json').then((index) => {
            ...
            pt.verifyPostSettings(locators.post_settings_header, text_validation.post_settings_header)
            ...
            cy.get('div.modal-content').within(() => {
                pt.verifyDeletePopUp(locators.delete_post_verification_header, text_validation.pop_up_delete_header)
