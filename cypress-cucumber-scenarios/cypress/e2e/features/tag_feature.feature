...
Scenario: As a user I want to create a public tag using all the form
...
Scenario: As a user I try to create a tag without define a name  
      Given I signin to Ghost
      And I wait for 2 seconds
      When I navigate to tags page
      And I wait for 1 seconds
...
Scenario: As a user I want to create a public tag defining just the tag name
      Given I signin to Ghost
      And I wait for 2 seconds
      When I navigate to tags page
      And I wait for 1 seconds
...
Scenario: As a user I want to create a public tag using a name with 200 characters
      Given I signin to Ghost
      And I wait for 2 seconds
      When I navigate to tags page
      And I wait for 1 seconds
